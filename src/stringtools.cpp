...
{
   std::vector<unsigned long> unicode = ToUnicodeVec(utf8);
...
std::vector<unsigned long> StringTools::ToUnicodeVec(const std::string& utf8)
{
    std::vector<unsigned long> unicode;
    const std::vector<unsigned long> errorData;
